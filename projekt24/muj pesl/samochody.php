...
<html>
    ...
    <body>
        ...
        <section id="pSrodkowy">
            ...
            <?php
                $zapytanie = mysqli_query($polaczenie, "SELECT samochody.id, samochody.model, zamowienia.telefon FROM samochody INNER JOIN zamowienia WHERE samochody.id=zamowienia.Samochody_id;");
                if (mysqli_num_rows($zapytanie) > 0) {
                    while ($wiersz = mysqli_fetch_array($zapytanie)) {
